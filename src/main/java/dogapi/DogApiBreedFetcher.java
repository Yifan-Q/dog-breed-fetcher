...
public class DogApiBreedFetcher implements BreedFetcher {
    ...
    public List<String> getSubBreeds(String breed) {
        ...
        String request_url = "https://dog.ceo/api/breed/" + breed.toLowerCase() + "/list";
        ...
        try {
            ...
            if (Objects.equals(responseBody.getString("status"), "success")){
                ...
                JSONArray subBreeds_j = responseBody.getJSONArray("message");
                ArrayList<String> subBreeds = new ArrayList<>();
                for (int i = 0; i < subBreeds_j.length(); i++){
                    subBreeds.add(i, subBreeds_j.getString(i));
                }
                return subBreeds;
